...
import TrangShop from './trang/TrangShop';
    ...
    <NhaCungCapXacThuc>
      <BrowserRouter>
        <Routes>
          ...
          {/* Trang shop - layout rieng */}
          <Route path="/" element={<TrangShop />} />
          <Route path="/shop" element={<TrangShop />} />
          <Route path="/gio-hang" element={<TrangShop />} />
