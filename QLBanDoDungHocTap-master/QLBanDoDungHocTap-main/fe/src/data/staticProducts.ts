...
export const duLieuSanPhamTinh: SanPhamAPI[] = [
  taoSanPham(1001, 'van-phong-pham', 'Bút lông bảng StudyHub WB-01', 'Bút lông bảng - lông dầu', 'StudyHub', 18000, 12000, 0),
  ...
  taoSanPham(1005, 'van-phong-pham', 'Băng keo văn phòng StudyHub 2cm', 'Băng keo', 'StudyHub', 12000, 7000, 4),
  ...
  taoSanPham(1009, 'van-phong-pham', 'Giấy ghi chú StudyHub Sticky Note', 'Giấy ghi chú', 'StudyHub', 25000, 16000, 8),
  taoSanPham(1010, 'van-phong-pham', 'Giấy note Flexoffice 5 màu', 'Giấy ghi chú', 'Flexoffice', 30000, 19000, 9),

  taoSanPham(2001, 'sach-vo', 'Tập học sinh StudyHub 96 trang', 'Tập học sinh', 'StudyHub', 14000, 9000, 0),
  ...
  taoSanPham(2004, 'sach-vo', 'Sổ tay StudyHub planner mini', 'Sổ tay', 'StudyHub', 52000, 35000, 3),
  taoSanPham(2005, 'sach-vo', 'Nhãn vở Colokit chống nước', 'Nhãn vở', 'Colokit', 10000, 6000, 4),
  taoSanPham(2006, 'sach-vo', 'Nhãn vở StudyHub dễ bóc', 'Nhãn vở', 'StudyHub', 12000, 7000, 5),
  ...
  taoSanPham(2009, 'sach-vo', 'Combo học tập StudyHub đầu năm', 'Combo học tập', 'StudyHub', 99000, 70000, 8),
  ...
  taoSanPham(3002, 'dung-cu-ve', 'Bút lông màu StudyHub 24 màu', 'Bút lông màu', 'StudyHub', 78000, 52000, 1),
  ...
  taoSanPham(3006, 'dung-cu-ve', 'Màu nước StudyHub basic set', 'Màu nước', 'StudyHub', 125000, 84000, 5),
  ...
  taoSanPham(3010, 'dung-cu-ve', 'Acrylic Marker StudyHub pro', 'Acrylic Marker', 'StudyHub', 135000, 92000, 9),

  taoSanPham(4001, 'ba-lo-tui', 'Ba lô học sinh StudyHub tiểu học', 'Ba lô học sinh', 'StudyHub', 285000, 210000, 0),
  taoSanPham(4002, 'ba-lo-tui', 'Ba lô học sinh Flexoffice năng động', 'Ba lô học sinh', 'Flexoffice', 320000, 235000, 1),
  taoSanPham(4003, 'ba-lo-tui', 'Cặp chống gù StudyHub Air', 'Cặp chống gù', 'StudyHub', 560000, 420000, 2),
  taoSanPham(4004, 'ba-lo-tui', 'Cặp chống gù Flexoffice Premium', 'Cặp chống gù', 'Flexoffice', 610000, 460000, 3),
  taoSanPham(4005, 'ba-lo-tui', 'Túi đựng dụng cụ StudyHub mini', 'Túi đựng dụng cụ', 'StudyHub', 69000, 45000, 4),
  taoSanPham(4006, 'ba-lo-tui', 'Túi đựng dụng cụ Flexoffice zipper', 'Túi đựng dụng cụ', 'Flexoffice', 82000, 55000, 5),
  taoSanPham(4007, 'ba-lo-tui', 'Hộp viết StudyHub 2 ngăn', 'Hộp viết', 'StudyHub', 58000, 37000, 6),
  taoSanPham(4008, 'ba-lo-tui', 'Hộp viết Flexoffice canvas', 'Hộp viết', 'Flexoffice', 73000, 48000, 7),
  taoSanPham(4009, 'ba-lo-tui', 'Ba lô học sinh StudyHub chống thấm', 'Ba lô học sinh', 'StudyHub', 355000, 260000, 8),
  taoSanPham(4010, 'ba-lo-tui', 'Túi đựng dụng cụ Flexoffice pastel', 'Túi đựng dụng cụ', 'Flexoffice', 99000, 67000, 9),

  taoSanPham(5001, 'dien-tu-hoc-tap', 'Máy tính khoa học StudyHub FX-580VN', 'Máy tính khoa học', 'StudyHub', 620000, 510000, 0),
  taoSanPham(5002, 'dien-tu-hoc-tap', 'Máy tính khoa học Flexoffice SC-991', 'Máy tính khoa học', 'Flexoffice', 580000, 470000, 1),
  taoSanPham(5003, 'dien-tu-hoc-tap', 'Máy tính văn phòng StudyHub CAL-01', 'Máy tính văn phòng', 'StudyHub', 165000, 120000, 2),
  taoSanPham(5004, 'dien-tu-hoc-tap', 'Máy tính văn phòng Flexoffice Desk', 'Máy tính văn phòng', 'Flexoffice', 189000, 138000, 3),
  taoSanPham(5005, 'dien-tu-hoc-tap', 'Phụ kiện học tập StudyHub đèn đọc sách', 'Phụ kiện học tập', 'StudyHub', 145000, 102000, 4),
  taoSanPham(5006, 'dien-tu-hoc-tap', 'Phụ kiện học tập Flexoffice quạt mini', 'Phụ kiện học tập', 'Flexoffice', 128000, 90000, 5),
  taoSanPham(5007, 'dien-tu-hoc-tap', 'Máy tính khoa học StudyHub học sinh', 'Máy tính khoa học', 'StudyHub', 540000, 430000, 6),
  taoSanPham(5008, 'dien-tu-hoc-tap', 'Máy tính văn phòng Flexoffice slim', 'Máy tính văn phòng', 'Flexoffice', 210000, 158000, 7),
  taoSanPham(5009, 'dien-tu-hoc-tap', 'Phụ kiện học tập StudyHub giá đỡ tablet', 'Phụ kiện học tập', 'StudyHub', 175000, 126000, 8),
