...
namespace DAL
{
    public class HoaDonNhap_DAL
    {
        ...
        public async Task<List<HoaDonNhap>> GetAllAsync()
        {
            ...
            const string sql = @"
                SELECT hdNhap_id, nhaCungCap_id, taiKhoan_id AS nhanVien_id, maHDNhap, ngayNhap, tongTien, ghiChu, trangThai
                FROM HoaDonNhap
        ...
        {
            const string sql = @"
                INSERT INTO HoaDonNhap (nhaCungCap_id, taiKhoan_id, maHDNhap, tongTien, ghiChu)
